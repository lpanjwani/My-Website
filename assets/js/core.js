    ...
    Component: {
        ...
        instagramFeed: function(){
            ...
            var feed = new Instafeed({
                ...
                template: '<a href="../../{{link}}/default.htm" target="_blank"><img src="../../{{image}}/default." /></a>',
                limit: limit
            });
            feed.run();
        },
        ...
        sectionVideo: function() {
            $('.section-video .btn-play').on('click', function(){
                ...
                $container =  $(this).parents('.section-video');
